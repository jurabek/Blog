...
namespace IdentityPermissionExtension
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <returns></returns>
        public virtual async Task<TPermission> CreatePermissionAsync(string name,
            long origin,
            ...
            HttpContextBase httpContext = null)
        {
            ...
            if (permission == null)
            {
                ...
                await AddInitialRolesAsync(newPerm, null);
        ...
        {
            TPermission permission = await FindPermissionAsync(name, 0, isGlobal);
        ...
        /// <param name="permission"></param>
        /// <returns></returns>
        private async Task AddInitialRolesAsync(TPermission permission, TRole role)
        {
            ...
            await Task.Run(() =>
            {
                ...
                {
                    permission.Roles = new List<TRolePermission> { rolePermission };
                }
            });
        }

        public async Task AddToRole(TPermission permission, TKey roleId)
        {
            var rolePermission = new TRolePermission()
            {
                RoleId = roleId,
